...
import numpy as np
import Nio, Ngl, os, sys, wrf
from wrf import getvar, latlon_coords, to_np


# Read data
dirname = "/share/mzhang/jas983/wrf_data/eas5555/wrfwrk/ARW/NYpvow_A5Dx3D/2011jan23-24/wrfrun_z46r1bl5cu300ls2/"
filename = "wrfout_d03_2011-01-24_01:00:00"
...
# Read some WRF data
a  = Nio.open_file(dirname+filename+".nc")  # Must add ".nc" suffix for Nio.open_file
ua = getvar(a,"ua")
va = getvar(a,"va")
