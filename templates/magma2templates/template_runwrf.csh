...
#SBATCH --ntasks=24		# Total number of tasks to be configured for.
#SBATCH --tasks-per-node=24	# sets number of tasks to run on each node.
...
#SBATCH -t 400:00:00		# Run time (hh:mm:ss)
